...
import com.wipro.raemisclient.poll.GNodeBPolling;
...
public class StartApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		new Timer().schedule(new GNodeBPolling(), 0, Constants.POLL_INTERVAL_10_SEC);
